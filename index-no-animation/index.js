...
TweenMax.from(
    geometryOneItem,
    1,
    {x: 0, y: 0, opacity: 0, delay: 1, visibility: "hiden" }
);
TweenMax.from(
    geometryTwoItem,
    1,
    {x: 0, y: 0, opacity: 0, delay: 1.3,}
);
TweenMax.from(
    geometryThreeItem,
    1,
    {x: 0, y: 0, opacity: 0, delay: 1.6,}
);


TweenMax.from(logo, 1, {opacity: 0, delay: 1.5,});
TweenMax.from(hamburgerMenu, 1, {opacity: 0, delay: 1.5,});

TweenMax.from(welcomeText, 0.5, {
    opacity: 0, x: 300, delay: 0.8,
});
